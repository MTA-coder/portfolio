...
const ResponsiveTimelineSystem: React.FC<ResponsiveTimelineSystemProps> = ({ items }) => {
  ...
  return (
    <div className="responsive-timeline-container relative px-4 md:px-0" ref={timelineRef}>
      ...
      <div className={cn(
        ...
        >
          <motion.div
            ...
            animate={settings.animations && isActive ? { 
              scale: [1, 1.2, 1],
            } : {}}
